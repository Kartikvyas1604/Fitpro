...
const Footer = () => {
  return (
    <footer
      ...
      className="footer"
    >
      <section className="bg-light py-9 py-md-9 py-xl-9 border-top border-light" style={{width: "100%"}}>
        <div className="container overflow-hidden">
          <div className="row gy-4 gy-lg-0 justify-content-xl-between">
            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
              <div className="widget">
                <p style={{ color: "black", fontSize: "50px" }}>FITPRO</p>
              </div>
            </div>
            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
              <div className="widget">
                <h4 style={{ color: "black" }} className="widget-title mb-4">
                  Get in Touch
                </h4>
